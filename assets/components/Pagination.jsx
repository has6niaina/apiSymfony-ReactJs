...
const Pagination = ({currentPage, itemsPerPage, length, onPageChanged}) => {
    const pagesCount = Math.ceil(length / itemsPerPage); //math.ceil arrondir à motié superieur
    ...
    return ( 
        ...
        <ul className="pagination pagination-sm">
            <li className={"page-item"  + (currentPage === 1 && " disabled")}>
                <button onClick={() => onPageChanged(currentPage - 1)} className="page-link">&laquo;</button>
            </li>
                {pages.map(page => 
